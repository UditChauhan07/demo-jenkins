                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="{{ route('basicmoney.show',$module->id) }}"><i class="icon-copy ion-eye"></i></a>
                                    @can('basicmoney-edit')
                                    <a class="btn btn-primary" href="{{ route('basicmoney.edit',$module->id) }}"><i class="icon-copy ti-pencil-alt"></i></a>
                                    @endcan
                                    @if($module->is_active == 1)
                                    <?php $status = 0; ?>
                                    @can('basicmoney-delete')   
                                    {!! Form::open(['method' => 'DELETE','route' => ['basicmoney.destroy', $module->id ],'style'=>'display:inline', 'onclick' => '']) !!}
                                    ...
                                    <?php $status = 1; ?>
                                    @can('basicmoney-delete')   
                                    {!! Form::open(['method' => 'post','route' => ['basicmoney.unblock', $module->id ],'style'=>'display:inline', 'onclick' => '']) !!}
                    ...
                    <div class="card-block table-border-style">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info" href="{{ route('basicmoney.show',$modules->id) }}"><i class="icon-copy ion-eye"></i></a>
                                    @can('chaldname-edit')   
                                    <a class="btn btn-primary" href="{{ route('basicmoney.edit',$modules->id) }}"><i class="icon-copy ti-pencil-alt"></i></a>
                                    @endcan
                                    @can('chaldname-delete')
                                    {!! Form::open(['method' => 'DELETE','route' => ['basicmoney.destroy', $modules->id],'style'=>'display:inline', 'onclick' => '']) !!}
