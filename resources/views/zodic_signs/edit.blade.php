            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('zodic_sign', null, array('placeholder' => 'Zodiac Sign','class' => 'form-control')) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Zodic Number :</strong>
                        {!! Form::number('zodic_number', null, array('placeholder' => 'Zodiac Number','class' => 'form-control')) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Zodic Day :</strong>
                        {!! Form::text('zodic_day', null, array('placeholder' => 'Zodiac Day','class' => 'form-control')) !!}
                    </div>
                </div>
