...
<div class="main-container">
    ...
    @endif
    <div class="pd-20 card-box mb-30">
        {!! Form::model($compatibility_description, ['method' => 'PATCH','route' => ['compatibility_description.update', $compatibility_description->id]]) !!}
                 @csrf
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!!Form::select('type', array('1' => 'Car/Vehicle', '2' => 'Business', '3' => 'Property', '4' => 'Other Person', '5' => 'Spouse/Partner', '6' => 'Name Reading'), 
                            $compatibility_description->type, array('placeholder' => 'Type','class' => 'form-control', 'disabled'))!!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
