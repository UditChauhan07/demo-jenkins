    ...
    <div class="pd-20 card-box mb-30">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td><img src="{{ url('/thumbnail/'.$video->video_thumbnail)}}" alt="Video Thumbnail" width="100%" height="60%"></td>
                @else
                <td><img src="{{ url('/thumbnail/default_thumbnail.png')}}"alt="Video Thumbnail" width="100%" height="100%"></td>
                @endif
