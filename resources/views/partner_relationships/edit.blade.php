...
<div class="main-container">
    <div class="pd-20 card-box mb-30">
        <div class="row">
            <div class="col-md-6">
                <div class="">
                    <h2>Edit Number {{ $partner_relationship->number }}</h2>
                </div>
            </div>
            <div class="col-md-6">
    ...
    @endif
    <div class="pd-20 card-box mb-30">
        {!! Form::model($partner_relationship, ['method' => 'PATCH','route' => ['partner_relationships.update', $partner_relationship->id]]) !!}
                 @csrf
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::text('mate_number', null, array('placeholder' => 'Mate Number','class' => 'form-control', 'disabled')) !!}
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
