        ...
        <div class="card-block table-border-style">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-info" href="{{ route('childrens.show',$module->id) }}"><i class="icon-copy ion-eye"></i></a>
                        @can('children-edit')
                        <a class="btn btn-primary" href="{{ route('childrens.edit',$module->id) }}"><i class="icon-copy ti-pencil-alt"></i></a>
                        @endcan
                        @if($module->is_active == 1)
                        @can('children-delete')   
                        {!! Form::open(['method' => 'DELETE','route' => ['childrens.destroy', $module->id ],'style'=>'display:inline', 'onclick' => '']) !!}
                        ...
                        @can('children-delete')   
                        {!! Form::open(['method' => 'post','route' => ['childrens.unblock', $module->id ],'style'=>'display:inline', 'onclick' => '']) !!}
