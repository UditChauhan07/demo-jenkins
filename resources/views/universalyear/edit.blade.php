...
<div class="main-container">
    <div class="pd-20 card-box mb-30">
        <div class="row">
            <div class="col-md-6">
                <div class="">
                    <h2>Edit Universal Year</h2>
                </div>
            </div>
            <div class="col-md-6">
                <div class="text-right">
                <a class="btn btn-primary" href="{{ route('universalyear.index') }}"> Back </a>
                </div>
            </div>
        </div>
    </div>
    ...
    @endif
    <div class="pd-20 card-box mb-30">
        {!! Form::model($module, ['method' => 'PATCH','route' => ['universalyear.update', $module->id]]) !!}
            <div class="row">
